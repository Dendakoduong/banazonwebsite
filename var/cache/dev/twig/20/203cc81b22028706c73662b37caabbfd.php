...
/* _carousel.html.twig */
class __TwigTemplate_e2fa757eedb5e2bfc874c03b8f206fb8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"carousel-inner\">
        ...
        foreach ($context['_seq'] as $context["key"] => $context["header"]) {
            ...
            echo "</p>
                        <p><a class=\"btn btn-lg btn-outline-dark\" href=\"";
            // line 16
            ...
            <div class=\"carousel-item {{key == 0 ? 'active' : ''}}\"
                ...
                <div class=\"container\">
                    <div class=\"carousel-caption text-left\">
                        <h2>{{header.title}}</h2>
                        <p>{{header.content}}</p>
                        <p><a class=\"btn btn-lg btn-outline-dark\" href=\"{{header.btnUrl}}\" role=\"button\">{{header.btnTitle}}</a></p>
                    </div>
                </div>
            </div>
        {% endfor %}
...
</div>", "_carousel.html.twig", "C:\\Users\\Acer\\ecommerce-symfony\\templates\\_carousel.html.twig");
    }
}
