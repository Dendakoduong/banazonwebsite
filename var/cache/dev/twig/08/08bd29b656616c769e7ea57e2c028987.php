...
class __TwigTemplate_f64d027dae888c841fb5c1d2b171f7c1 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"my-5 py-5 text-center\">
    ...
    <h1 class=\"display-6 fw-bold\">Vous n'avez pas les droits nécessaires pour afficher cette page</h1>
...
<div class=\"my-5 py-5 text-center\">
    ...
    <h1 class=\"display-6 fw-bold\">Vous n'avez pas les droits nécessaires pour afficher cette page</h1>
    <div class=\"col-lg-6 mx-auto\">
        <p class=\"lead mb-4 text-muted\">{{ status_code }} Accès non autorisé</p>
        <a href=\"{{ path('home') }}\">Retour à l'accueil</a>
    </div>
</div>

{% endblock %}", "@Twig/Exception/error403.html.twig", "C:\\Users\\Acer\\ecommerce-symfony\\templates\\bundles\\TwigBundle\\Exception\\error403.html.twig");
    }
}
