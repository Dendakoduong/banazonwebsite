...
class __TwigTemplate_eac9d0b2967db22dcdeb17467b968921 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"text-center\">
        ...
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/img/check-7058.svg"), "html", null, true);
        echo "\" alt=\"trade-in\" height=\"100px\" width=\"100px\">
    </div>

    <h1 class=\"text-center\">Thanks for your order!</h1>
    <p class=\"text-center\">
        We appreciate your business!
        If you have any questions, please contact us <a href=\"/contact\">here</a>.
    </p>
...
{% block body %}
    ...
    <div class=\"text-center\">
        <img class=\"img-fluid rounded\" src=\"{{ asset('assets/img/check-7058.svg') }}\" alt=\"trade-in\" height=\"100px\" width=\"100px\">
    </div>
...
{% endblock %}
", "payment/success.html.twig", "C:\\Users\\Acer\\banazonweb\\templates\\payment\\success.html.twig");
    }
}
