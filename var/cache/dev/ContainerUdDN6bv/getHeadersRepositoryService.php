 ...
 */
class getHeadersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HeadersRepository' shared autowired service.
     *
     * @return \App\Repository\HeadersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HeadersRepository.php';

        return $container->privates['App\\Repository\\HeadersRepository'] = new \App\Repository\HeadersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
